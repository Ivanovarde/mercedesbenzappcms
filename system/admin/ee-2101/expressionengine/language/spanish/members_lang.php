...
"invalid_path" =>
"La ruta que has enviado no es válida.",

"invalid_path_description" =>
"La siguiente ruta que enviaste no es válida:",
...
"Puede eliminarcategorias",

"can_not_delete_self" =>
"No tienes permitido eliminartu propia cuenta de miembro.",

"no_heirs_available" =>
"El miembro que intentas eliminartiene entradas de canal asignadas",
...
"delete_selected" =>
"Eliminar Miembros Seleccionadas",
...
"No hay cuentas de membresia esperando activación",

"members_are_validated" =>
"Miembro(s) ha(n) sido activado(s)",

"members_are_deleted" =>
"Miembro(s) ha(n) sido eliminado(s)",
...
"Crear un Nuevo Grupo de Miembros",
...
"delete_member_group" =>
"Eliminar Grupo de Miembro",

"member_group_deleted" =>
"Grupo de Miembros eliminado",

"delete_member_group_confirm" =>
"Estas seguro que deseas eliminareste grupo de miembro?",

"delete_member" =>
"Eliminar Miembro",

"delete_member_confirm" =>
"Estas seguro que deseas eliminareste miembro?",

"delete_members_confirm" =>
"Estas seguro que deseas eliminarestos miembros?",

"can_not_delete_superadmin" =>
"No puedes eliminarel miembro primario",
...
"ban_options" =>
"Cuando una IP intenta acceder al sitio",
...
"Solo Super Admins pueden acceder a la pagina de Grupos de Miembro",
...
"can_delete_self" =>
"Puede eliminarsu propia cuenta - borra todos los mensajes, entradas y comentarios",

"mbr_delete_notify_emails" =>
"Direccion de Correo de Recipientes para Notificacion de Elimminación",

"delete_confirmation_form" =>
"Formulario de Confirmacion de Eliminación de Cuenta",
...
"No hay Módulos con Acceso de Panel de Control Instalados",
...
"can_access_content" =>
"Puede acceder a la sección CONTENIDO",

"can_access_design" =>
"Puede acceder a la sección DISENO",

"can_access_addons" =>
"Puede acceder a la sección ADD-ONS",

"can_access_members" =>
"Puede acceder a la sección MIEMBROS",

"can_access_admin" =>
"Puede acceder a la sección ADMIN",

"can_access_tools" =>
"Puede acceder a la sección HERRAMIENTAS",
...
"Puede eliminarcomentarios en sus propias entradas de canal",

"can_edit_all_comments" =>
"Puede editar comentarios en CUALQUIER entrada de canal",

"can_delete_all_comments" =>
"Puede eliminarcomentarios en CUALQUIER entrada de canal",
...
"can_access_edit" =>
"Puede acceder a la sección CONTENIDO: Editar",

"can_access_publish" =>
"Puede acceder a la sección CONTENIDO: Publicar",

"can_access_files" =>
"Puede acceder a la sección CONTENIDO: Gestor de Archivos",

"can_access_modules" =>
"Puede acceder a la sección: ADD-ONS: Módulos",

"can_access_extensions" =>
"Puede acceder a la sección ADD-ONS: Extensiones",

"can_access_accessories" =>
"Puede acceder a la sección ADD-ONS: Accesorios",

"can_access_plugins" =>
"Puede acceder a la sección ADD-ONS: Plugins",

"can_access_comm" =>
"Puede acceder a la sección HERRAMIENTAS: Comunicacion",

"can_access_utilities" =>
"Puede acceder a la sección HERRAMIENTAS: Utilidades",

"can_access_data" =>
"Puede acceder a la sección  HERRAMIENTAS: Datos",

"can_access_logs" =>
"Puede acceder a la sección  HERRAMIENTAS: Registros",

"can_access_sys_prefs" =>
"Puede acceder a la sección ADMIN: Preferencias de Sistema",

"can_access_content_prefs" =>
"Puede acceder a la sección ADMIN: Preferencias de Contenido",

"can_delete_members" =>
"Puede eliminarmiembros",
...
"Puede eliminarsus propias entradas de canal",

"can_delete_all_entries" =>
"Puede eliminarentradas de canal de otros autores",
...
"Todos los datos de miembro contenidos en este campo seran eliminados permanentemente",

"profile_field_deleted" =>
"Campo de Miembro eliminado:",
...
"No puedes eliminarel único miembro en la base de datos",

"can_not_delete_super_admin" =>
"No puedes eliminarun Super Admin al menos que exista al menos uno mas",

"must_be_superadmin_to_delete_one" =>
"Debes ser un Super Admin para eliminarun Super Admin",
...
"Reenviar Correos de Activación",

"activation_emails_resent" =>
"Correos de Activación Reenviados",
