...
<table class="structure-table" border="0" cellspacing="0" cellpadding="0">
	...
	<tbody>
		<?php if ( ! $groups): ?>
			<tr>
				<td><?=lang('no_groups')?>: <strong><a href="<?=BASE.AMP.'C=members'.AMP.'M=member_group_manager';?>"><?=lang('no_groups_add')?> &rarr;</a></strong></td>
			</tr>
		<?php else: ?>
...
<div class="table-controls"><a href="#" class="submit"><?= lang('iv_save_module_settings') ?></a></div>
