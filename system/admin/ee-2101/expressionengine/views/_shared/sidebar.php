<div id="sideBar">
	...
	<div<?=$sidebar_state?> id="sidebarContent">
		...
		<div id="siteLogo">
			<a href="<?=BASE.AMP.'C=myaccount'.AMP.'M=edit_avatar'?>" id="user_avatar">
                <!-- IVANO -->
                <!--img src="<?//=$cp_avatar_path ? $cp_avatar_path : $cp_theme_url.'images/site_logo.gif'?>" width="50" alt="Site Logo" /-->              <?PHP
